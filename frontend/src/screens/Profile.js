...
const Profile = ({ history }) => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Link to="/addresses">
        <button className="btn btn-dark btn-lg mt-2" style={{ fontSize : "15px", width : "15%", height : "50px", borderRadius : "0px" }} onClick="document.location.href='address'">+ ADD NEW ADDRESS</button>
      </Link>
      <Typography
        variant='h5'
        sx={{
